<template>
  <div class="card hover:bg-base-200 mb-1 block p-2 text-sm break-all">
    <span class="text-main inline-block min-w-14">
      {{ log.time }}
    </span>
    <span class="badge badge-sm bg-base-200/50 ml-2 inline-block min-w-12 text-center">
      {{ seqWithPadding }}.
    </span>
    <span
      class="badge badge-sm bg-base-200/50 ml-2 inline-block min-w-17 text-center"
